    ...
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className={`bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 ${sidebarOpen ? 'w-64' : 'w-20'} flex flex-col`}>
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
          {sidebarOpen ? (
            <div className="text-xl font-semibold text-primary dark:text-primary-light">ImmoRef</div>
          ) : (
            <div className="text-xl font-semibold text-primary dark:text-primary-light mx-auto">IR</div>
          )}
