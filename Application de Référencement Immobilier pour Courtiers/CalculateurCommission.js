...
const CalculateurCommission = () => {
  ...
  // Options d'institutions financières avec différents pourcentages
  const institutions = [
    { id: 'default', nom: 'Standard', pourcentage: 1 },
    { id: 'banque_a', nom: 'Banque A', pourcentage: 0.8 },
    { id: 'banque_b', nom: 'Banque B', pourcentage: 1.2 },
    { id: 'banque_c', nom: 'Banque C', pourcentage: 1.5 },
    { id: 'credit_union', nom: 'Coopérative de crédit', pourcentage: 1.1 },
  ];

  // Paliers de bonus confirmés par l'utilisateur
  const paliers = [
    { seuil: 0, bonus: 0 },
  ...
  useEffect(() => {
    calculerCommission();
  }, [montantTotal, pourcentageCommission, volumeTotal, institutionFinanciere]);
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
            ...
            <tbody className="bg-white dark:bg-gray-700 divide-y divide-gray-200 dark:divide-gray-600">
              {paliers.map((palier, index) => (
                <tr key={index} className={volumeTotal >= palier.seuil ? "bg-blue-50 dark:bg-blue-900/20" : ""}>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                    {palier.seuil === 0 ? "Moins de 2M$" : palier.seuil === 2000000 ? "2M$ à 7M$" : palier.seuil === 7000000 ? "7M$ à 10M$" : "Plus de 10M$"}
                  </td>
